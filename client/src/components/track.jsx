    ...
    <div className="flex justify-between pr-3 mb-4 bg-gray-200 rounded-lg cursor-move xl:w-3/4 lg:w-5/6 md:w-3/4 sm:w-full">
      ...
      <div className="flex items-center justify-center w-24 ">
        <select
          id="rating"
          className={
            validate && rating == "notSelected"
              ? "bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-400 focus:border-gray-400 block w-full p-2.5 peer"
              : "bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-transparent focus:border-gray-400 block w-full p-2.5 peer"
          }
          required
